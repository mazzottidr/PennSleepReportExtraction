...
extract_baseline_13 <- function(paths) {
                ...
                tryCatch(
                        {
                            ...
                            #Get all possible tables
                                ...
                                #Fix columns names
                                colnames(word_main_values_df)[c(1:3,5:8)] <- paste0("B13_PSG_PHI_",colnames(word_main_values_df)[c(1:3,5:8)])
                                colnames(word_main_values_df)[-c(1:3,5:8)] <- paste0("B13_PSG_",colnames(word_main_values_df)[-c(1:3,5:8)])
                                
                                # Get other relevant values from the word document
                                
                                word_main_values_df$B13_PSG_study_type <- "Baseline Study"
                                word_main_values_df$B13_PSG_PHI_clinical_history <- grep("CLINICAL HISTORY:", textreadr::read_docx(PSGfilename), value = T)
                                word_main_values_df$B13_PSG_PHI_final_diagnosis <- get_final_diagnosis(TABLES)
                                word_main_values_df$B13_PSG_PHI_comm_rec <- get_comm_rec(TABLES)
                                
                                ### Get fields from Excel embedded tables that appear in the report
                                xl_tb <- PSGfilename
                                
                                #Copy file ################## Fix ths to be universal
                                dir.create("zips_b13/", showWarnings = F)
                                file.copy(from = PSGfilename, to = "zips_b13/")
                                file.rename(paste0("zips_b13/", strsplit(PSGfilename, "/")[[1]][6]), "zips_b13/current.zip")
                                unzip("zips_b13/current.zip", exdir = paste0(getwd(),"/zips_b13"))
                                xls_tables_paths <- grep("Worksheet", dir("zips_b13/word/embeddings/", full.names = T), value = T)
                                ...
                                if (!is.null(xlstb3)) {
                                        ...
                                        xls3_vars <- data.frame(
                                                ...
                                                #Oxygen saturation
                                                B13_PSG_maxSpO2_wake=as.numeric(as.character(xlstb3$Wake[1])),
                                                B13_PSG_meanSpO2_wake=as.numeric(as.character(xlstb3$Wake[2])),
                                                B13_PSG_minSpO2_wake=as.numeric(as.character(xlstb3$Wake[3])),
                                                B13_PSG_timeSpO2_LT89_wake=as.numeric(as.character(xlstb3$Wake[4])),
                                                B13_PSG_perctime_90.100_wake=as.numeric(as.character(xlstb3$Wake[6])),
                                                B13_PSG_perctime_80.89_wake=as.numeric(as.character(xlstb3$Wake[7])),
                                                B13_PSG_perctime_70.79_wake=as.numeric(as.character(xlstb3$Wake[8])),
                                                B13_PSG_perctime_badO2data_wake=as.numeric(as.character(xlstb3$Wake[12])),
                                                
                                                B13_PSG_maxSpO2_nrem=as.numeric(as.character(xlstb3$Non.REM[1])),
                                                B13_PSG_meanSpO2_nrem=as.numeric(as.character(xlstb3$Non.REM[2])),
                                                B13_PSG_minSpO2_nrem=as.numeric(as.character(xlstb3$Non.REM[3])),
                                                B13_PSG_timeSpO2_LT89_nrem=as.numeric(as.character(xlstb3$Non.REM[4])),
                                                B13_PSG_perctime_90.100_nrem=as.numeric(as.character(xlstb3$Non.REM[6])),
                                                B13_PSG_perctime_80.89_nrem=as.numeric(as.character(xlstb3$Non.REM[7])),
                                                B13_PSG_perctime_70.79_nrem=as.numeric(as.character(xlstb3$Non.REM[8])),
                                                B13_PSG_perctime_badO2data_nrem=as.numeric(as.character(xlstb3$Non.REM[12])),
                                                
                                                B13_PSG_maxSpO2_rem=as.numeric(as.character(xlstb3$REM[1])),
                                                B13_PSG_meanSpO2_rem=as.numeric(as.character(xlstb3$REM[2])),
                                                B13_PSG_minSpO2_rem=as.numeric(as.character(xlstb3$REM[3])),
                                                B13_PSG_timeSpO2_LT89_rem=as.numeric(as.character(xlstb3$REM[4])),
                                                B13_PSG_perctime_90.100_rem=as.numeric(as.character(xlstb3$REM[6])),
                                                B13_PSG_perctime_80.89_rem=as.numeric(as.character(xlstb3$REM[7])),
                                                B13_PSG_perctime_70.79_rem=as.numeric(as.character(xlstb3$REM[8])),
                                                B13_PSG_perctime_badO2data_rem=as.numeric(as.character(xlstb3$REM[12])),
                                                
                                                B13_PSG_maxSpO2_tst=as.numeric(as.character(xlstb3$TST[1])),
                                                B13_PSG_meanSpO2_tst=as.numeric(as.character(xlstb3$TST[2])),
                                                B13_PSG_minSpO2_tst=as.numeric(as.character(xlstb3$TST[3])),
                                                B13_PSG_timeSpO2_LT89_tst=as.numeric(as.character(xlstb3$TST[4])),
                                                B13_PSG_perctime_90.100_tst=as.numeric(as.character(xlstb3$TST[6])),
                                                B13_PSG_perctime_80.89_tst=as.numeric(as.character(xlstb3$TST[7])),
                                                B13_PSG_perctime_70.79_tst=as.numeric(as.character(xlstb3$TST[8])),
                                                B13_PSG_perctime_badO2data_tst=as.numeric(as.character(xlstb3$TST[12])),
                                                
                                                B13_PSG_maxSpO2_tib=as.numeric(as.character(xlstb3$TIB[1])),
                                                B13_PSG_meanSpO2_tib=as.numeric(as.character(xlstb3$TIB[2])),
                                                B13_PSG_minSpO2_tib=as.numeric(as.character(xlstb3$TIB[3])),
                                                B13_PSG_timeSpO2_LT89_tib=as.numeric(as.character(xlstb3$TIB[4])),
                                                B13_PSG_perctime_90.100_tib=as.numeric(as.character(xlstb3$TIB[6])),
                                                B13_PSG_perctime_80.89_tib=as.numeric(as.character(xlstb3$TIB[7])),
                                                B13_PSG_perctime_70.79_tib=as.numeric(as.character(xlstb3$TIB[8])),
                                                B13_PSG_perctime_badO2data_tib=as.numeric(as.character(xlstb3$TIB[12])),stringsAsFactors = F)
                                } else {xls3_vars <- NULL}
                                ...
                                if (!is.null(xlstb4)) {
                                        ...
                                        xls4_vars <- data.frame(       
                                                #Pulse rate
                                                B13_PSG_maxHR_wake=as.numeric(as.character(xlstb4$Wake[1])),
                                                B13_PSG_meanHR_wake=as.numeric(as.character(xlstb4$Wake[2])),
                                                B13_PSG_minHR_wake=as.numeric(as.character(xlstb4$Wake[3])),
                                                
                                                B13_PSG_maxHR_nrem=as.numeric(as.character(xlstb4$Non.REM[1])),
                                                B13_PSG_meanHR_nrem=as.numeric(as.character(xlstb4$Non.REM[2])),
                                                B13_PSG_minHR_nrem=as.numeric(as.character(xlstb4$Non.REM[3])),
                                                
                                                B13_PSG_maxHR_rem=as.numeric(as.character(xlstb4$REM[1])),
                                                B13_PSG_meanHR_rem=as.numeric(as.character(xlstb4$REM[2])),
                                                B13_PSG_minHR_rem=as.numeric(as.character(xlstb4$REM[3])),
                                                
                                                B13_PSG_maxHR_tst=as.numeric(as.character(xlstb4$TST[1])),
                                                B13_PSG_meanHR_tst=as.numeric(as.character(xlstb4$TST[2])),
                                                B13_PSG_minHR_tst=as.numeric(as.character(xlstb4$TST[3])), stringsAsFactors = F)
                                } else {xls4_vars <- NULL}
                                ...
                                if (!is.null(xlstb5)) {
                                        ...
                                        xls5_vars <- data.frame(    
                                                #Oxygen desats
                                                B13_PSG_desats_tst_idx=as.numeric(xlstb5$Index[1]),
                                                B13_PSG_desats_tst_count=as.numeric(xlstb5$Count[1]),
                                                
                                                B13_PSG_desats_nrem_idx=as.numeric(xlstb5$Index[2]),
                                                B13_PSG_desats_nrem_count=as.numeric(xlstb5$Count[2]),
                                                
                                                B13_PSG_desats_rem_idx=as.numeric(xlstb5$Index[3]),
                                                B13_PSG_desats_rem_count=as.numeric(xlstb5$Count[3]),stringsAsFactors = F)
                                } else {xls5_vars <- NULL}
                                ...
                                colnames(extrapsgdata) <- paste0("B13_PSG_EXTRA_",t(xlstb_combined_extraonly$Var_name))
                                
                                ######### Remove all files from zip_folder to avoid confusion when getting new data
                                file.remove(list.files("zips_b13/", include.dirs = F, full.names = T, recursive = T))
                                
                                ######## Combine ALL data
                                
                                all_fields <- c("B13_PSG_PHI_Filename", "PennSleepID", colnames(word_main_values_df), colnames(xls3_vars), colnames(xls4_vars), colnames(xls5_vars), colnames(extrapsgdata))
        ...
        final_df$B13_PSG_Age_at_Study <- interval(mdy(final_df$B13_PSG_PHI_NPBMPatientInfoDOB), mdy(final_df$B13_PSG_NPBMStudyInfoStudyDate)) %/% years(1)
        ...
        QC_df <- data.frame(B13_PSG_PHI_Filename=identifiable_df$B13_PSG_PHI_Filename,
                            # Missing both MRN fields
                            has_missingMRN=is.na(identifiable_df$B13_PSG_PHI_NPBMSiteInfoHospitalNumber),
                            # Gender not (Male, Female, Unknown)
                            has_missingGender=!(tolower(identifiable_df$B13_PSG_NPBMPatientInfoGender) %in% c("male", "female", "unknown")),
                            # Missing age
                            has_missingAge=is.na(identifiable_df$B13_PSG_Age_at_Study),
                            # Missing BMI
                            has_missingBMI=is.na(identifiable_df$B13_PSG_NPBMPatientInfoBMI)
        )
        ...
        saveRDS(identifiable_df, paste0("PennSleepDatabase_Baseline13_", ProcessedTimeID, ".Rdata"))
        ...
        write.csv(deidentified_df, paste0("PennSleepDatabase_Baseline13_Deidentified",ProcessedTimeID,".csv"), row.names = F)
